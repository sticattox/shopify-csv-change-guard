...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        action="append",
        default=[],
        help="Column you meant to change. Repeatable. Other field changes become REVIEW.",
    )
    parser.add_argument(
        "--intend-file",
        default="",
    ...
    result = compare_csvs(original, edited, intended_columns=intended)
    if args.out:
